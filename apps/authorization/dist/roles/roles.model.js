...
__decorate([
    (0, decorators_1.ApiProperty)({ example: 'ADMIN', description: 'Уникальное значение роли' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], Role.prototype, "value", void 0);
__decorate([
    (0, decorators_1.ApiProperty)({ example: 'Администратор', description: 'Описание роли' }),
